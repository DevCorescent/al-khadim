...
const ENV_DOMAIN = process.env.MAIL_DOMAIN || 'alkhadim.ae';
...
function identityFor(module, domain = ENV_DOMAIN) {
...
function listIdentities(domain = ENV_DOMAIN) {
...
function invalidateSmtpSettingsCache() {
 ...
 */
async function logDirectSend({ module, to, cc, bcc, subject, html, text, status, error, campaignId, recipientId, recipientName, createdBy }) {
  try {
 ...
 * @param {{module?:string,to:string,cc?:string,bcc?:string,subject:string,
 *          html?:string,text?:string,replyTo?:string,attachments?:any[],
 *          scheduledEmailId?:string,campaignId?:string,recipientId?:string,
 *          recipientName?:string,createdBy?:string}} opts
 */
...
module.exports = {
  sendMail, identityFor, listIdentities, IDENTITIES, ENV_DOMAIN,
  getTransport, loadSmtpSettings, invalidateSmtpSettingsCache,
};
