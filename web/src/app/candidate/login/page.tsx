    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="hidden lg:flex lg:w-5/12 bg-slate-900 flex-col justify-between p-14 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <p className="text-primary-400 text-xs font-bold tracking-widest uppercase mb-4">CANDIDATE PORTAL</p>
          <h2 className="text-4xl font-bold text-white leading-tight mb-4">
            Track your<br />career journey<br />
            <span className="text-gray-400 font-normal">all in one place.</span>
          </h2>
          <p className="text-gray-400 text-sm leading-relaxed">
            View your application status, manage your profile, explore new opportunities, and stay updated on every step of your candidature.
          </p>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            <div className="inline-flex items-center gap-2 bg-primary-50 border border-primary-100 rounded-full px-3 py-1 mb-4">
              ...
              <span className="text-xs font-semibold text-primary-600">Candidate Portal</span>
            </div>
            <h1 className="text-3xl font-bold text-gray-900 tracking-tight mb-2">Sign in</h1>
            <p className="text-gray-400 text-sm">Access your candidate dashboard</p>
          </div>
          ...
          <p className="text-center text-sm text-gray-400 mt-8">
            ...
            <Link href="/candidate/register" className="text-primary-500 font-semibold hover:underline">
              Upload your CV →
            </Link>
          </p>
